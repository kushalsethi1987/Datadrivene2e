...
public class TestConfig{
	...
	public static String from ="kushal.sethi.nkaps@gmail.com";
	public static String password = "jpvewapduthhhjdq";
	public static String[] to ={"reena.runam@gmail.com","testingbluestacksformyself@gmail.com"};
